            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <form action="{{ route('pesanan.store') }}" method="post" role="form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control @error('bobot') is-invalid @enderror"
                                            type="text" name="bobot" id="bobot"
                                            value="{{ old('bobot') }}" placeholder="Bobot Cucian">
                                    </div>
                                    @error('bobot')
